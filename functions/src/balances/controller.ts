...
module.exports.onCreate = f.firestore.document(BalanceFirestore.virtualPath).onCreate(async (snapshot, context) => {
...
// module.exports.onUpdate = f.firestore.document(BalanceFirestore.virtualPath).onUpdate(async (snapshot, context) => {
//   if (await isTriggeredOnce(context.eventId)) {
//     return;
//   }
...
// module.exports.onDelete = f.firestore.document(BalanceFirestore.virtualPath).onDelete(async (snapshot, context) => {
//   if (await isTriggeredOnce(context.eventId)) {
//     return;
//   }
