...
module.exports.onCreate = functions.firestore
  .document(SinglePriceNormalSettlementFirestore.virtualPath)
...
module.exports.onUpdate = functions.firestore
  .document(SinglePriceNormalSettlementFirestore.virtualPath)
...
module.exports.onDelete = functions.firestore
  .document(SinglePriceNormalSettlementFirestore.virtualPath)
