...
module.exports.onCreate = f.firestore.document(PrimaryAskFirestore.virtualPath).onCreate(async (snapshot, context) => {
...
// module.exports.onUpdate = f.firestore.document(PrimaryAskFirestore.virtualPath).onUpdate(async (snapshot, context) => {
//   if (await isTriggeredOnce(context.eventId)) {
//     return;
//   }
...
// module.exports.onDelete = f.firestore.document(PrimaryAskFirestore.virtualPath).onDelete(async (snapshot, context) => {
//   if (await isTriggeredOnce(context.eventId)) {
//     return;
//   }
