...
export const main = $root.main = (() => {
    ...
    main.DailyPayment = (function() {
         ...
         * @property {number|null} [year] DailyPayment year
         * @property {number|null} [month] DailyPayment month
         * @property {number|null} [date] DailyPayment date
         * @property {number|null} [amount_kwh] DailyPayment amount_kwh
         */
         ...
         * @instance
         */
        DailyPayment.prototype.month = 0;
         ...
         * @instance
         */
        DailyPayment.prototype.amount_kwh = 0;
        ...
        DailyPayment.encode = function encode(message, writer) {
            ...
            if (message.date != null && Object.hasOwnProperty.call(message, "date"))
                writer.uint32(/* id 5, wireType 1 =*/41).double(message.date);
            if (message.amount_kwh != null && Object.hasOwnProperty.call(message, "amount_kwh"))
                writer.uint32(/* id 6, wireType 1 =*/49).double(message.amount_kwh);
            return writer;
        };
        ...
        DailyPayment.toObject = function toObject(message, options) {
            ...
            if (message.date != null && message.hasOwnProperty("date"))
                object.date = options.json && !isFinite(message.date) ? String(message.date) : message.date;
            if (message.amount_kwh != null && message.hasOwnProperty("amount_kwh"))
    ...
    main.DeltaAmount = (function() {
         ...
         * @property {string|null} [asks_amount] DeltaAmount asks_amount
         * @property {string|null} [bids_amount] DeltaAmount bids_amount
         */
        ...
        /**
         * DeltaAmount asks_amount.
         * @member {string} asks_amount
         * @memberof main.DeltaAmount
         * @instance
         */
        DeltaAmount.prototype.asks_amount = "";

        /**
         * DeltaAmount bids_amount.
         * @member {string} bids_amount
         * @memberof main.DeltaAmount
         * @instance
         */
        DeltaAmount.prototype.bids_amount = "";
        ...
        DeltaAmount.encode = function encode(message, writer) {
            ...
            if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                writer.uint32(/* id 1, wireType 2 =*/10).string(message.id);
            if (message.asks_amount != null && Object.hasOwnProperty.call(message, "asks_amount"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.asks_amount);
            if (message.bids_amount != null && Object.hasOwnProperty.call(message, "bids_amount"))
                writer.uint32(/* id 3, wireType 2 =*/26).string(message.bids_amount);
            return writer;
        };
        ...
        DeltaAmount.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    message.asks_amount = reader.string();
                    break;
                case 3:
                    message.bids_amount = reader.string();
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        DeltaAmount.verify = function verify(message) {
            ...
            if (message.id != null && message.hasOwnProperty("id"))
                if (!$util.isString(message.id))
                    return "id: string expected";
            if (message.asks_amount != null && message.hasOwnProperty("asks_amount"))
                if (!$util.isString(message.asks_amount))
                    return "asks_amount: string expected";
            if (message.bids_amount != null && message.hasOwnProperty("bids_amount"))
                if (!$util.isString(message.bids_amount))
                    return "bids_amount: string expected";
            return null;
        };
        ...
        DeltaAmount.fromObject = function fromObject(object) {
            ...
            if (object.id != null)
                message.id = String(object.id);
            if (object.asks_amount != null)
                message.asks_amount = String(object.asks_amount);
            if (object.bids_amount != null)
                message.bids_amount = String(object.bids_amount);
            return message;
        };
        ...
        DeltaAmount.toObject = function toObject(message, options) {
            ...
            if (message.id != null && message.hasOwnProperty("id"))
                object.id = message.id;
            if (message.asks_amount != null && message.hasOwnProperty("asks_amount"))
                object.asks_amount = message.asks_amount;
            if (message.bids_amount != null && message.hasOwnProperty("bids_amount"))
                object.bids_amount = message.bids_amount;
            return object;
        };
